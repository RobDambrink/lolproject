...
public class MasteriesPageLogic {
	...
	public MasteriesPageLogic(Hibernate hib){
		...
		saveMasteryPage(1L);
		editMasteryPage(1L, "testPageEdit2", new Integer[] {1234,2});
	}
	
	public void editMasteryPage(Long id, String name, Integer[] masteries){
	...
	public void saveMasteryPage(Long accountId){
